...
#pragma config(Motor,  port3,           rFDrive,       tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           lBDrive,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           rBDrive,       tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port6,           lManipulator,  tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port7,           rManipulator,  tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
