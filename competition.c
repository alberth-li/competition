...
#pragma config(Motor,  port9,           grabber,       tmotorVex393_MC29, openLoop)
  ...
  switch (autonomousChoice){
  	...
  	case 1:
  		...
  		while(SensorValue[grabPot]>1800){
			...
			/*moveMotorTarget(rFDrive, moveDistance(42), 80, true);
  		moveMotorTarget(rBDrive, moveDistance(42), 80, true);
  		moveMotorTarget(lFDrive, moveDistance(42), 80, true);
  		moveMotorTarget(lBDrive, moveDistance(42), 80, true);
  		...
  		zeroEncoders();
  		moveMotorTarget(rFDrive, moveDistance(12), 80, true);
  		moveMotorTarget(rBDrive, moveDistance(12), 80, true);
  		moveMotorTarget(lFDrive, moveDistance(12), 80, true);
  		moveMotorTarget(lBDrive, moveDistance(12), 80, true);
  		while(!getMotorTargetCompleted(rFDrive) || !getMotorTargetCompleted(rBDrive) || !getMotorTargetCompleted(lFDrive) || !getMotorTargetCompleted(lBDrive)){}
  		wait1Msec(300);
  		zeroEncoders();
  		moveMotorTarget(rFDrive, moveDistance(-12), 80, true);
